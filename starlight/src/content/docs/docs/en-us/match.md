...
- [Errors and types](errors-and-types) — the `Type` that becomes an HTTP status
- [Chain · `Then`](then) — what comes before `Match`
- [Recover · `Recover`](recover) — handle the failure **without** leaving the pipeline
