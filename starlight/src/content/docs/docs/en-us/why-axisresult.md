...
- [Railway-Oriented Programming](railway-oriented-programming) — the model these features implement
- [Getting started](getting-started) — install and start
- [API reference](api-reference) — the complete operator catalog
