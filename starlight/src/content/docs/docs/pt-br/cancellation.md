...
- [`Task` vs `ValueTask`](/teste-docs/docs/pt-br/async-task-vs-valuetask) — as duas famílias async que ganham variantes CT
- [Encadear · `Then`](/teste-docs/docs/pt-br/then) — o operador mais comum a receber o token
