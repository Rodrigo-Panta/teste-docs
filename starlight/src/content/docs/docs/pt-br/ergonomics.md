...
- [Sair · `Match`](match) — a outra forma de extrair o valor com segurança
- [Erros e tipos](errors-and-types) — o que o `[DebuggerDisplay]` de um `AxisError` mostra
- [Referência da API](api-reference) — a tabela de desestruturação
