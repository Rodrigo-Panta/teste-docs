...
> Precisa passar **detalhes** (id, quantidade tentada)? Emita **vários `AxisError`** — a lista de erros já é a coleção natural para isso. Veja [Agregar · `Combine`/`All`](/teste-docs/docs/pt-br/aggregate).
...
- [Remapear erros · `MapError`](/teste-docs/docs/pt-br/map-errors) — reescrever códigos/tipos ao cruzar camadas
- [Recuperar · `Recover`](/teste-docs/docs/pt-br/recover) — voltar da trilha de falha para a de sucesso
- [Sair · `Match`](/teste-docs/docs/pt-br/match) — converter o resultado final em resposta HTTP
