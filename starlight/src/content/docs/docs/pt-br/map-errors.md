...
|---|---|
| **recuperar** da falha (voltar ao sucesso) | [`Recover`](/teste-docs/docs/pt-br/recover) |
| só **observar** o erro (log) | [`TapError`](/teste-docs/docs/pt-br/tap) |
...
- [Erros e tipos](/teste-docs/docs/pt-br/errors-and-types) — o que um `AxisError` carrega
- [Recuperar · `Recover`](/teste-docs/docs/pt-br/recover) — tratar a falha em vez de só reescrevê-la
- [Sair · `Match`](/teste-docs/docs/pt-br/match) — onde os erros viram resposta final
