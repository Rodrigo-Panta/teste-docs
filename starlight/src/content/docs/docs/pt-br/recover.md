...
> O oposto do [`Then`](/teste-docs/docs/pt-br/then): opera na **trilha de falha**. `Recover` e seus parentes trazem o pipeline de volta ao sucesso — sempre de forma **deliberada e explícita**.
...
|---|---|
| só **observar** o erro (log) sem recuperar | [`TapError`](/teste-docs/docs/pt-br/tap) |
| **reescrever** o erro, não recuperar | [`MapError`](/teste-docs/docs/pt-br/map-errors) |
...
- [Erros e tipos](/teste-docs/docs/pt-br/errors-and-types) — `IsTransient`, tipos e códigos para condicionar a recuperação
- [Remapear erros · `MapError`](/teste-docs/docs/pt-br/map-errors) — transformar o erro em vez de recuperar
- [Garantir · `Ensure`](/teste-docs/docs/pt-br/ensure) — o oposto: levar do sucesso à falha
