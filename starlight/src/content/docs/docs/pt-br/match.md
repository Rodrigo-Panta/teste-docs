...
- [Erros e tipos](/teste-docs/docs/pt-br/errors-and-types) — o `Type` que vira status HTTP
- [Encadear · `Then`](/teste-docs/docs/pt-br/then) — o que vem antes do `Match`
- [Recuperar · `Recover`](/teste-docs/docs/pt-br/recover) — tratar a falha **sem** sair do pipeline
