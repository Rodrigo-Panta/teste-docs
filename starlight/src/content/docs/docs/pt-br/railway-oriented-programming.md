...
- [Primeiros passos](getting-started) — instalar e escrever o primeiro pipeline
- [Encadear · `Then`](then) — a chave de desvio mais importante
- [Por que AxisResult?](why-axisresult) — comparação com outras libraries de Result
