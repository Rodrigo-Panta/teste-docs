...
|---|---|
| um passo que **pode falhar** (retorna `AxisResult`) | [`Then`](/teste-docs/pt-br/then) |
| **observar** o valor sem transformá-lo | [`Tap`](/teste-docs/pt-br/tap) |
| transformar **erros**, não o valor | [`MapError`](/teste-docs/pt-br/map-errors) |
...
|---|---|---|
| `Map` | `T → TNew` | sync · `Task` · `ValueTask` · [+CT](/teste-docs/pt-br/cancellation) |
| `Select` | `T → TNew` (sintaxe LINQ) | sync |
| `Map((a, b) => …)` | desestrutura a tupla de [`Zip`](/teste-docs/pt-br/zip) | `Task` (tuplas T2–T4) |
...
- [Encadear · `Then`](/teste-docs/pt-br/then) — quando o próximo passo pode falhar
- [Combinar · `Zip`](/teste-docs/pt-br/zip) — manter dois valores e desestruturar no `Map`
- [Efeitos · `Tap`](/teste-docs/pt-br/tap) — observar sem transformar
